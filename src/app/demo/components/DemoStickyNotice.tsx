...
export function DemoStickyNotice() {
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg, #0d7f6c 0%, #15a488 100%)",
    ...
    >
      <div className="max-w-5xl mx-auto px-4 py-2.5 md:py-3 flex items-center justify-between gap-3">
        ...
        <a
          href="/web"
          className="flex-shrink-0 inline-flex items-center gap-1 bg-white text-[#0d7f6c] rounded-full px-3 py-1.5 md:px-4 md:py-2 text-[11px] md:text-xs font-bold hover:bg-gray-50 active:scale-95 transition-all"
        >
          他のデモを見る
          <svg
            width="12"
