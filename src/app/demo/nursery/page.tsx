...
export default function NurseryPage() {
  ...
  return (
    ...
    >
      ...
      {showCta && (
        <div
          className="nursery-cta-bar fixed bottom-0 left-0 right-0 z-40 px-4 py-3 flex items-center justify-between gap-3"
          style={{
            backgroundColor: "rgba(255, 248, 240, 0.97)",
            backdropFilter: "blur(12px)",
            borderTop: "1px solid rgba(245,158,66,0.25)",
            boxShadow: "0 -4px 20px rgba(245,158,66,0.1)",
          }}
          role="complementary"
        ...
        >
          ...
          <a
            href="#contact"
            className="flex items-center justify-center gap-2 flex-1 py-2.5 rounded-lg font-medium text-sm transition-all duration-200 hover:opacity-80"
            style={{ border: "1px solid rgba(245,158,66,0.6)", color: "#F59E42" }}
