...
// metadata is exported from a separate layout or handled via generateMetadata
// For client components, we set the title via useEffect
const PAGE_TITLE = "BLUE AMAMI | 奄美大島のダイビングショップ";
