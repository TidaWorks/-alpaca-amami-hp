    ...
    >
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
          {/* 構築費用 */}
          <div
            className="relative bg-white border border-[#E5E7EB] rounded-2xl shadow-sm hover:shadow-md transition-all duration-700"
            style={{
              opacity: visible ? 1 : 0,
          ...
          >
            <div className="p-7 md:p-8">
              ...
              <a
                href="#contact"
                className="block w-full text-center text-sm font-black text-white bg-[#635BFF] rounded-full py-3.5 shadow-md hover:shadow-lg hover:bg-[#5249E0] transition-all"
              >
                このプランで相談する →
              </a>
            </div>
          ...
          {/* 保守 */}
          <div
            className="relative bg-gradient-to-br from-[#635BFF]/5 to-[#FFC400]/5 border border-[#E5E7EB] rounded-2xl shadow-sm hover:shadow-md transition-all duration-700"
            style={{
              opacity: visible ? 1 : 0,
              transform: visible ? "translateY(0)" : "translateY(24px)",
          ...
          >
            <div className="absolute -top-4 -right-3 z-10">
              <div className="bg-[#FFC400] text-[#1A202C] text-[10px] font-black tracking-widest px-3 py-1.5 rounded shadow-md rotate-[3deg]">
                ★ 推奨
              </div>
            </div>
            ...
            <div className="p-7 md:p-8">
              ...
              <a
                href="#contact"
                className="block w-full text-center text-sm font-black text-[#1A202C] bg-[#FFC400] rounded-full py-3.5 shadow-md hover:shadow-lg hover:brightness-95 transition-all"
              >
                保守について相談する →
              </a>
            </div>
