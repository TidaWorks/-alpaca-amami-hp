...
export default function SystemCTA() {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="relative bg-gradient-to-br from-white via-[#F5F3FF] to-[#EFF6FF] pt-20 md:pt-28 pb-12 px-6 scroll-mt-20 overflow-hidden border-t border-[#E5E7EB]"
    >
        ...
        >
          ...
          {submit === "success" ? (
            ...
            <form onSubmit={onSubmit} className="space-y-5" noValidate>
              <div>
                <label htmlFor="sys-name" className="block text-[11px] font-bold tracking-[0.2em] text-[#1A202C] mb-2">
                  お名前
                </label>
                <input
                  id="sys-name"
              ...
              <div>
                <label htmlFor="sys-email" className="block text-[11px] font-bold tracking-[0.2em] text-[#1A202C] mb-2">
                  メールアドレス
                </label>
                <input
                  id="sys-email"
              ...
              <div>
                <label htmlFor="sys-message" className="block text-[11px] font-bold tracking-[0.2em] text-[#1A202C] mb-2">
                  メッセージを入力
                </label>
                <textarea
                  id="sys-message"
              ...
              >
                <span
                  ...
                  style={{
                    ...
                    animation: submit === "submitting" ? undefined : "sysCtaShine 1.4s ease-out",
                  }}
                />
