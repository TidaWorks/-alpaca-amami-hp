...
const FAQS = [
  {
    q: "どこから相談すればいいですか？",
    a: "契約後にご案内するチャット窓口に、業務の悩みでもAI活用でも、なんでも気軽にお送りください。営業日24時間以内に返信します。",
  },
  {
    q: "月5時間以内の軽実装って、どれくらいの作業が含まれますか？",
    a: "お問い合わせの自動応答づくり、繰り返し作業をAIで肩代わりさせる仕組みづくり、文章作成・要約・翻訳のサポート、業務にAIを取り入れる初期設定、ホームページの軽微な修正など、小さな業務改善のお手伝いを月5時間ぶんお引き受けします。",
  },
  {
    q: "もっと大きな案件をお願いしたい場合はどうなりますか？",
    a: "本格的な自動応答ボット構築・ホームページ制作・業務システム開発が必要になった場合は、スマート特典価格にてお見積もりします。通常価格より割引価格でご案内します。",
  },
  {
    q: "解約したい時はどうすればいいですか？",
    a: "最低契約期間は3ヶ月です。4ヶ月目以降はいつでも月単位で解約可能です。解約申請は前月末までにチャット経由でご連絡ください。",
  },
  {
    q: "島外(鹿児島本土・東京等)でも契約できますか？",
    a: "はい、オンラインで完結します。チャット＋オンラインミーティングで運用するため、所在地に関係なくご利用いただけます。",
  },
  {
    q: "業種制限はありますか？",
