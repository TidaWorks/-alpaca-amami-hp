...
- dev起動: `npx next dev --port 3001`

## 料金体系（2026-04-24更新）
- ライトプラン（LP1ページ）: ¥70,000〜120,000（納期3日〜1週間）
- スタンダードプラン（複数ページHP）: ¥250,000〜400,000（納期2週間〜4週間）
- 業務改善システム構築: ¥300,000〜（要見積、納品後も継続改善）
- 保守サポート: LP ¥5,000〜/月 / HP ¥10,000〜/月 / システム ¥20,000〜/月
- サーバー・ドメインを自主管理する場合は保守なし買い切りも対応可
- SEOは初期設定のみ（継続的なSEO対策は範囲外）
- 素材（写真・ロゴ）はお客様用意、LINE連携はオプション
